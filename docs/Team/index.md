...
| <img src = "images/profile_imran_noor.jpg" width ="200"><br><sub>Picture from...</sub><br>  [Linkedin](https://www.linkedin.com/in/md-imran-noor-69abb9106/) &nbsp; | Hi, I’m Noor, a Ph.D. student in Dr. Anthoni Luque’s Virus Ecology and Ecology Lab at the University of Miami. I was born and raised in Bangladesh, where I earned my bachelor degree in Fisheries and Marine Resource Technology from Khulna University. I also hold a master’s degree in Biochemistry and Molecular Biology from the University of Texas Rio Grande Valley.
My current research in the Luque Lab is centered on engineering innovative and stable capsid designs for Adeno-Associated Viruses (AAV) that can accommodate larger genomes. This advancement could significantly enhance AAV’s potential as a vector in gene therapy applications.
Outside of academia, I enjoy reading, watching movies, playing RPG and action-adventure games, and spending quality time with my family.|
